  ...
  return (
    <Card>
      <CardContent className="p-5">
        ...
        <div className="mt-2 text-2xl font-bold tracking-tight text-card-foreground">{value}</div>
