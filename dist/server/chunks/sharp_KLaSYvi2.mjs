import { M as MissingSharp, P as NoImageMetadata, Z as UnsupportedImageFormat, t as AstroError } from "./errors_CS7Ixuqe.mjs";
import { c as resolveDefaultOutputFormat, o as detector, r as parseQuality, t as baseService } from "./service_ZOGcmp9e.mjs";
//#region node_modules/.pnpm/astro@7.1.6_@emnapi+core@2.0.0-alpha.3_@emnapi+runtime@2.0.0-alpha.3_jiti@1.21.7_rollup@4.62.3_yaml@2.9.0/node_modules/astro/dist/assets/services/sharp.js
var sharp;
var qualityTable = {
	low: 25,
	mid: 50,
...
async function loadSharp() {
	let sharpImport;
	try {
		sharpImport = (await import("./dist_CDTBqdw6.mjs")).default;
	} catch {
