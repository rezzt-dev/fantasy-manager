import { M as MissingSharp, P as NoImageMetadata, Z as UnsupportedImageFormat, t as AstroError } from "./errors_DkTnxlG4.mjs";
import { c as resolveDefaultOutputFormat, o as detector, r as parseQuality, t as baseService } from "./service_BITdvbpE.mjs";
//#region node_modules/.pnpm/astro@7.1.6_@emnapi+core@2.0.0-alpha.3_@emnapi+runtime@2.0.0-alpha.3_@types+node@26.1.2_60d4126fd3af7df7e44934f15c10628c/node_modules/astro/dist/assets/services/sharp.js
var sharp;
var qualityTable = {
	low: 25,
	mid: 50,
...
async function loadSharp() {
	let sharpImport;
	try {
		sharpImport = (await import("./dist_ubPNoHDg.mjs")).default;
	} catch {
