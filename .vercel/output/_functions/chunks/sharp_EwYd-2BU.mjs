import { N as NoImageMetadata, Q as AstroError, X as UnsupportedImageFormat, j as MissingSharp } from "./errors-data_17rTywjF.mjs";
import { v as detector } from "./path_CRwkzUmU.mjs";
import { i as resolveDefaultOutputFormat, r as parseQuality, t as baseService } from "./service_yAk9uGXc.mjs";
//#region node_modules/.pnpm/astro@7.2.2_@emnapi+core@1.11.1_@emnapi+runtime@1.11.3_@types+node@26.2.0_@upstash+redi_ebca85d2548909f750ea74eae4debbc1/node_modules/astro/dist/assets/services/sharp.js
var sharp;
var qualityTable = {
	low: 25,
	mid: 50,
...
async function loadSharp() {
	let sharpImport;
	try {
		sharpImport = (await import("./dist_DbDi6uPo.mjs")).default;
	} catch {
